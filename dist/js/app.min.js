...
var searchBox=$(".search-box"),searchBtn=$("a.btn-search");searchBtn.click(function(){return $(this).hide(),searchBox.addClass("active"),!1}),$(document).click(function(){searchBtn.show(),searchBox.removeClass("active")}),searchBox.click(function(c){c.stopPropagation()});