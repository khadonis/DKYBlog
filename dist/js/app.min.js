...
/*! Main Script */
function clickStop(e){e.click(function(e){e.stopPropagation()})}function slideBtnNextAct(e){e<mainSlide.length&&(slideImg=mainSlide.eq(e).find("img").attr("src"),slideImgtitle=mainSlide.eq(e).find("img").attr("alt"),slideThumb.css("background-image","url("+slideImg+")"),slideBtnTxt.empty().text(slideImgtitle))}var searchBox=$(".search-box"),searchBtn=$("a.btn-search"),menuBtn=$(".menu-toggle"),navMenu=$(".nav-menu"),menuClose=$(".btn-close");searchBtn.click(function(){return $(this).hide(),searchBox.addClass("active"),!1}),$(document).click(function(){searchBtn.show(),searchBox.removeClass("active"),navMenu.removeClass("active")}),clickStop(navMenu),clickStop(searchBox),menuBtn.click(function(e){e.preventDefault(),e.stopPropagation(),navMenu.addClass("active")}),menuClose.click(function(){navMenu.removeClass("active")});var slideThumb=$(".nb-img"),slideTitle=$(".ng-txt"),mainSlide=$(".main-swiper-container .swiper-slide"),slideBtnTxt=$(".nb-txt"),indexX,slideImg,slideImgtitle;slideBtnNextAct(1);var mainSwiper=new Swiper(".main-swiper-container",{slidesPerView:"auto",centeredSlides:!0,nextButton:".main-swiper-button-next",prevButton:".main-swiper-button-prev",autoplay:4e3,runCallbacksOnInit:!0,onSlideChangeStart:function(){slideBtnNextAct(indexX=mainSwiper.realIndex+1),""==slideImg||void 0==slideImg?(slideThumb.width(0),slideThumb.css("min-width","0")):(slideThumb.width("auto"),slideThumb.css("min-width","150px")),""==slideImgtitle||void 0==slideImgtitle?slideBtnTxt.css("padding","0"):slideBtnTxt.css("padding","30px")},breakpoint:{slidesPerView:1}}),blogYaziSwiper=new Swiper(".blog-swiper-container",{nextButton:".blog-swiper-button-next",prevButton:".blog-swiper-button-prev",autoplay:4e3}),newsSwiper=new Swiper(".news-swiper-container",{paginationClickable:!0,nextButton:".news-swiper-button-next",prevButton:".news-swiper-button-prev",direction:"vertical",autoplay:4e3}),sayfaLinki=window.location.href,instagramRef,instagramLink,youtubeLink;$(".box-item.social-menu").each(function(){var e="http://www.facebook.com/sharer.php?u="+sayfaLinki,t="https://twitter.com/share?url="+sayfaLinki,i="https://plus.google.com/share?url="+sayfaLinki;instagramRef=$(this).siblings().eq(1).find("h2").text();for(var n=new Array("ı","ş","ç","ü","ö","ğ","İ","Ş","Ç","Ü","Ö","Ğ"),a=new Array("i","s","c","u","o","g","I","S","C","U","O","G"),s=0;s<n.length;s++)instagramRef=instagramRef.replace(new RegExp(n[s],"g"),a[s]);instagramRef=instagramRef.replace(/\s/g,"_"),instagramRef=instagramRef.replace(/\W+/g,""),$(this).find(".fa-facebook").parent().attr("href",e),$(this).find(".fa-twitter").parent().attr("href",t),$(this).find(".fa-google-plus").parent().attr("href",i),$(this).parent("article")&&(instagramLink="https://www.instagram.com/dkyinsaat/?ref="+sayfaLinki,youtubeLink="https://www.youtube.com/dkyinsaat/?ref="+sayfaLinki),$(this).parent(".box")&&(instagramLink="https://www.instagram.com/dkyinsaat/?ref="+instagramRef,youtubeLink="https://www.youtube.com/dkyinsaat/?ref="+instagramRef),$(this).find(".fa-instagram").parent().attr("href",instagramLink),$(this).find(".fa-youtube").parent().attr("href",youtubeLink)});